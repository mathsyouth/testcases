...
from testcases import clients
from testcases.common import credentials_factory as credentials
import testcases.common.validation_resources as vresources
...
class BaseTestCase(testtools.testcase.WithAttributes,
                   testtools.TestCase):
    """The test base class defines Testcases framework for class level fixtures.
