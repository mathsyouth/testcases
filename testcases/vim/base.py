...
from testcases.common import compute
from testcases.common.utils import data_utils
from testcases.common.utils.linux import remote_client
...
class ScenarioTest(testcases.test.BaseTestCase):
    """Base class for scenario tests. Uses testcases own clients. """
