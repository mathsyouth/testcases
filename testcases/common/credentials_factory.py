...
from testcases.common import dynamic_creds
from testcases.common import preprov_creds
...
and so they may not hold any dependency to testcases configuration.
...
def get_credentials_provider(name, network_resources=None,
    ...
    if CONF.auth.use_dynamic_credentials or force_tenant_isolation:
        ...
        return dynamic_creds.DynamicCredentialProvider(
            ...
            extra_roles=CONF.auth.testcases_roles,
