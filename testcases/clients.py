...
class Manager(clients.ServiceClients):
    """Top level manager for OpenStack testcases clients"""

    default_params = config.service_client_config()

    # TODO(andreaf) This is only used by baremetal clients,
    # and should be removed once they are out of Testcases
    ...
    def _prepare_configuration(self):
        ...
        """
        # NOTE(andreaf) Once all service clients in Testcases are migrated
        # to tempest.lib, their configuration will be picked up from the
        # registry, and this method will become redundant.

        configuration = {}

        # Setup the parameters for all Testcases services which are not in lib.
        # NOTE(andreaf) Since client.py is an internal module of Testcases,
